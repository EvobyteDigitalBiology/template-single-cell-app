# case-scrnaseq/django/backend/settings/production.py
...
USE_X_FORWARDED_HOST =  bool(utils.load_check_env_var('USE_X_FORWARDED_HOST'))
USE_X_FORWARDED_PORT =  bool(utils.load_check_env_var('USE_X_FORWARDED_PORT'))
